...
public class WhilePanel extends Panel implements ActionListener {
	private JTextField value1,value2;
	private JButton submit;
	private JRadioButton[] rela;
	private ButtonGroup bg;
	private String[] labelstr = {"while", "値:", "値２:", "関係演算子:"};
	private JLabel[] labels;

	WhilePanel(int x, int y, int w, int h, JTextArea t) {
		super(x, y, w, h, t);
...
//		}
	...
	private String getData(){
		GetWhile gw = new GetWhile(value1.getText());
		return gw.get();
	}
